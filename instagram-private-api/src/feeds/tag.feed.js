...
var TagFeed = /** @class */ (function (_super) {
    __extends(TagFeed, _super);
    function TagFeed() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(TagFeed.prototype, "state", {
        set: function (body) {
    ...
    TagFeed.prototype.request = function () {
    ...
    TagFeed.prototype.items = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
