...
var TagsFeed = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, lodash_1.flatten(response.sections.map(function (section) {
    ...
    ], TagsFeed.prototype, "nextMaxId");
    __decorate([
        class_transformer_1.Expose()
    ], TagsFeed.prototype, "nextPage");
    __decorate([
        class_transformer_1.Expose()
    ], TagsFeed.prototype, "nextMediaIds");
    return TagsFeed;
}(feed_1.Feed));
