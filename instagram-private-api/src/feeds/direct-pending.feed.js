...
var DirectPendingInboxFeed = /** @class */ (function (_super) {
    __extends(DirectPendingInboxFeed, _super);
    function DirectPendingInboxFeed() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(DirectPendingInboxFeed.prototype, "state", {
        set: function (body) {
    ...
    DirectPendingInboxFeed.prototype.request = function () {
    ...
    DirectPendingInboxFeed.prototype.items = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DirectPendingInboxFeed.prototype.records = function () {
        return __awaiter(this, void 0, void 0, function () {
            var threads;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    ], DirectPendingInboxFeed.prototype, "cursor");
    __decorate([
        class_transformer_1.Expose()
    ], DirectPendingInboxFeed.prototype, "seqId");
    return DirectPendingInboxFeed;
}(feed_1.Feed));
