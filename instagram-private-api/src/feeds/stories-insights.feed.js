...
var StoriesInsightsFeed = /** @class */ (function (_super) {
    ...
    Object.defineProperty(StoriesInsightsFeed.prototype, "state", {
        set: function (response) {
            var _a = response.data.user.business_manager.stories_unit.stories.page_info, end_cursor = _a.end_cursor, has_next_page = _a.has_next_page;
    ...
    ], StoriesInsightsFeed.prototype, "timeframe");
    __decorate([
        class_transformer_1.Expose()
    ], StoriesInsightsFeed.prototype, "nextCursor");
