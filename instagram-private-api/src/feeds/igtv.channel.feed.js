...
var IgtvChannelFeed = /** @class */ (function (_super) {
    __extends(IgtvChannelFeed, _super);
    function IgtvChannelFeed() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(IgtvChannelFeed.prototype, "state", {
    ...
    IgtvChannelFeed.prototype.request = function () {
    ...
    IgtvChannelFeed.prototype.items = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], IgtvChannelFeed.prototype, "maxId");
    return IgtvChannelFeed;
}(feed_1.Feed));
