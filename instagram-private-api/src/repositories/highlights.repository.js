...
var HighlightsRepository = /** @class */ (function (_super) {
    __extends(HighlightsRepository, _super);
    function HighlightsRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HighlightsRepository.prototype.highlightsTray = function (userId) {
    ...
    HighlightsRepository.prototype.createReel = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    HighlightsRepository.prototype.editReel = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    HighlightsRepository.prototype.deleteReel = function (highlightId) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
