...
var DiscoverRepository = /** @class */ (function (_super) {
    __extends(DiscoverRepository, _super);
     ...
     */
    DiscoverRepository.prototype.chaining = function (targetId) {
    ...
    DiscoverRepository.prototype.topicalExplore = function () {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DiscoverRepository.prototype.markSuSeen = function () {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DiscoverRepository.prototype.profileSuBadge = function () {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
