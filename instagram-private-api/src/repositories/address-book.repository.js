...
var AddressBookRepository = /** @class */ (function (_super) {
    __extends(AddressBookRepository, _super);
    function AddressBookRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AddressBookRepository.prototype.link = function (contacts, module) {
    ...
    AddressBookRepository.prototype.acquireOwnerContacts = function (me) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
