...
var AdsRepository = /** @class */ (function (_super) {
    __extends(AdsRepository, _super);
    function AdsRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AdsRepository.prototype.graphQL = function (options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            ...
                            method: 'POST',
                            qs: __assign({ locale: this.client.state.language, vc_policy: 'insights_policy' }, (options.surface.name ? { surface: options.surface.name } : {})),
                            form: {
