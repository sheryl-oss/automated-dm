...
var IgtvRepository = /** @class */ (function (_super) {
    ...
    IgtvRepository.prototype.search = function (query) {
    ...
    IgtvRepository.prototype.allUserSeries = function (user, data) {
        if (data === void 0) { data = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
    ...
    IgtvRepository.prototype.createSeries = function (title, description) {
